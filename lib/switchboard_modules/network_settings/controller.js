...
function module() {
    ...
    **/
    this.configureModuleContext = function(framework) {
        ...
        var hasWiFi = false;
        hasWiFi = self.activeDevice.savedAttributes.HARDWARE_INSTALLED.wifi;
        self.moduleContext.hasWiFi = hasWiFi = self.activeDevice.savedAttributes.HARDWARE_INSTALLED.wifi;
